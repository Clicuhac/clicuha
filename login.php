...
<main class="container py-4">
  ...
  <form method="post" class="card p-3" style="max-width:420px;">
    <div class="mb-3">
      ...
      <input type="email" name="email" class="form-control" autocomplete="email" required value="<?= h($email ?? '') ?>">
    </div>
    <div class="mb-3">
...
<footer class="border-top py-4 mt-4"><div class="container text-center small text-muted">© <?= date('Y') ?> Clicuha</div></footer>
